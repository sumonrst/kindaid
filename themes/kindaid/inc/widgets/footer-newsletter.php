...
class Footer_newsletter_shortcode_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            <label><?php _e('Upload Logo:', 'textdomain'); ?></label>
        ...
        <p>
            <label><?php _e('Newsletter Shortcode:', 'textdomain'); ?></label>
            <input class="widefat" type="text"
                name="<?php echo $this->get_field_name('newsletter_shortcode'); ?>"
                value="<?php echo esc_attr( $newsletter_shortcode ); ?>">
        </p>

        <p>
            <label><?php _e('Twitter / X URL:', 'textdomain'); ?></label>
            <input class="widefat" type="url"
        ...
        <p>
            <label><?php _e('Dribbble URL:', 'textdomain'); ?></label>
            <input class="widefat" type="url"
