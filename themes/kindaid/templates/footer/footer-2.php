 ...
 <footer>
      ...
      <div class="tp-footer-area tp-footer-3-style bg-position tp-bg-mulberry" data-img-bg="<?php echo esc_url($footer_bg_image); ?>">
         <?php 
         if ( is_active_sidebar( 'footer-2-widget-1' ) || is_active_sidebar( 'footer-2-widget-2' ) || is_active_sidebar( 'footer-2-widget-3' ) || is_active_sidebar( 'footer-2-widget-4' )) : ?>
            <div class="container container-1424 pt-120">
               <div class="row pb-60">
                  <?php 
                  if ( is_active_sidebar( 'footer-2-widget-1' ) ) : ?>
                  ...
                  <?php 
                  if ( is_active_sidebar( 'footer-2-widget-2' ) ) : ?>
                  ...
                  <?php 
                  if ( is_active_sidebar( 'footer-2-widget-3' ) ) : ?>
                  ...
                  <?php 
                  if ( is_active_sidebar( 'footer-2-widget-4' ) ) : ?>
