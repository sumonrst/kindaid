...
<?php 
    ...
    $kindaid_post_gallery = function_exists('tpmeta_gallery_field') ? tpmeta_gallery_field('kindaid_post_gallery') : ''; //tpmeta_gallery_field($string_ids, $size)

    //var_dump($kindaid_post_gallery);

    // echo '<pre>';
    // print_r( $kindaid_post_gallery );
    // echo '</pre>';
