...
<?php 
    ...
    $blog_category_show_hide = get_theme_mod( 'blog_category_show_hide', false );

    // Single Post Category Display Class
    $single_post_page_cat_class = is_single() ? 'position-static mb-20' : '';
?>

<?php 
if ( $blog_category_show_hide && !empty($cat_name) ) : ?>
    <div class="tp-postbox-cat <?php echo esc_attr($single_post_page_cat_class); ?>">
