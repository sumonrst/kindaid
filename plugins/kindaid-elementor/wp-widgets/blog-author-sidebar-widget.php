...
class Blog_Author_Sidebar_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Kindaid Blog Author Sidebar Widget', 'kindaid'),
            array( 'description' => __( 'Kindaid Blog Author Sidebar Widget', 'kindaid' ) )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label><?php _e('Upload Author Image:', 'kindaid'); ?></label>
        ...
        <p>
            <label><?php _e('Author Sub Title:', 'kindaid'); ?></label>
            <textarea class="widefat" rows="4"
                name="<?php echo esc_attr( $this->get_field_name('author_sub_title') ); ?>"><?php
        ...
        <p>
            <label><?php _e('Author Name:', 'kindaid'); ?></label>
            <textarea class="widefat" rows="4"
                name="<?php echo esc_attr( $this->get_field_name('author_name') ); ?>"><?php
                echo esc_textarea( $author_name ); ?></textarea>
        </p>

        <p>
            <label><?php _e('Author URL:', 'kindaid'); ?></label>
            <input class="widefat" type="url"
                name="<?php echo esc_attr( $this->get_field_name('author_url') ); ?>"
        ...
        <p>
            <label><?php _e('Twitter URL :', 'kindaid'); ?></label>
        ...
        <p>
            <label><?php _e('Driball URL :', 'kindaid'); ?></label>
            <input class="widefat" type="text"
                name="<?php echo esc_attr( $this->get_field_name('driball_url') ); ?>"
        ...
        <p>
            ...
            <input class="widefat" type="text"
                name="<?php echo esc_attr( $this->get_field_name('instragram_url') ); ?>"
