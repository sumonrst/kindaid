...
class Footer_Contact_Cta_2_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Kindaid Footer Concact CTA 2 Widget', 'kindaid'),
            array( 'description' => __( 'Kindaid Footer Contact Info CTA 2 Widget', 'kindaid' ) )
        );
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $title ) ) {
            echo kindaid_kses( $args['before_title'] ) . esc_html( $title ) . kindaid_kses( $args['after_title'] );
        }
        ?>
